...
CREATE DATABASE [PackageDelivery]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PackageDelivery', SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'PackageDelivery_log', SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [PackageDelivery]
GO
/****** Object:  User [yegor]    Script Date: 3/29/2024 1:05:27 PM ******/
CREATE USER [yegor] WITHOUT LOGIN WITH DEFAULT_SCHEMA=[dbo]
GO
