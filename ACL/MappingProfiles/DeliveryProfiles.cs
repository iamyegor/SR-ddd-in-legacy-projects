            ...
            .AfterMap(
                (src, dest) =>
                {
                    ...
                    if (notDeletedProductLines.Count > 0)
                    {
                        ...
                        dest.PRD_LN_1_AMN = line.Amount.ToString(CultureInfo.InvariantCulture);
                    }
                    ...
                    if (notDeletedProductLines.Count > 1)
                    {
                        ...
                        dest.PRD_LN_2_AMN = line.Amount.ToString(CultureInfo.InvariantCulture);
                    }
                    ...
                    if (notDeletedProductLines.Count > 2)
                    {
                        ...
                        dest.PRD_LN_3_AMN = line.Amount.ToString(CultureInfo.InvariantCulture);
                    }
                    ...
                    if (notDeletedProductLines.Count > 3)
                    {
                        ...
                        dest.PRD_LN_4_AMN = line.Amount.ToString(CultureInfo.InvariantCulture);
                    }
                }
            );
    }
